...
| **Database management** | Migration management (481), schema evolution, performance optimization, data integrity | Continuous |
...
|---------|------|-----------------|------------------|
| **Supabase** | Backend infrastructure (database, auth, storage, edge functions) | Critical | Low — deeply integrated (380+ tables, 80 edge functions, RLS policies). Migration would be major effort |
