...
|----------|-------------|-------------|
| **Platform codebase** | React + TypeScript frontend (160+ pages), 61 Deno edge functions, 369+ PostgreSQL tables, 403 migrations. Represents 2+ years of development | Critical |
...
|---------|------|-----------------|------------------|
| **Supabase** | Backend infrastructure (database, auth, storage, edge functions) | Critical | Low — deeply integrated (369+ tables, 61 edge functions, RLS policies). Migration would be major effort |
