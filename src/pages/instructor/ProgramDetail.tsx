      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <div className="flex items-center gap-3 mb-2">
            {program.logo_url && (
              <img src={program.logo_url} alt={program.name} className="h-12 w-12 object-contain" />
            )}
            <div>
                ...
                >
                  ...
                  <CardContent className="space-y-4" onClick={(e) => e.stopPropagation()}>
                    ...
                    {!!module.links &&
                      ...
                      (module.links as { name: string; url: string }[]).length > 0 && (
                        <div className="space-y-2">
                          <p className="text-sm font-medium">Resource Links:</p>
                          <div className="flex flex-wrap gap-2">
                            {(module.links as { name: string; url: string }[]).map(
                              (link, linkIndex) => (
