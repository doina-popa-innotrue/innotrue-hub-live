    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      <div className="space-y-2">
        ...
        <Input
          ...
          required
          placeholder="e.g., Salesforce Scenario Short"
        />
      </div>
      ...
      <div className="space-y-2">
        ...
        <Textarea
          ...
          rows={2}
          placeholder="What types of resources belong in this category?"
        />
      </div>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground">Available for use in resources</p>
        </div>
        <Switch
          id="is_active"
