    ...
    <div className="space-y-6">
          ...
          <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Link a user to their Lucid account
                </DialogDescription>
              </DialogHeader>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Users linked to their Lucid accounts
            </CardDescription>
          </CardHeader>
          <CardContent>
            {mappingsLoading ? (
                    ...
                    <TableRow key={mapping.id}>
                      ...
                      <TableCell className="text-right">
                        <div className="flex justify-end gap-2">
                          <Dialog open={editingMapping?.id === mapping.id} onOpenChange={(open) => !open && setEditingMapping(null)}>
                            <DialogTrigger asChild>
                            ...
                            <AlertDialogContent>
                              <AlertDialogHeader>
                                ...
                                <AlertDialogDescription>
                                  Are you sure you want to remove the Lucid mapping for {mapping.user_name}? 
                                  This will disconnect their account from Lucid.
                                </AlertDialogDescription>
                              </AlertDialogHeader>
                              <AlertDialogFooter>
