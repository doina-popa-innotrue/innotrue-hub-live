        ...
        <CardContent>
          <div className="grid gap-4 sm:grid-cols-2">
            {activeCategories.map((category) => {
              ...
              const hasChanges = editedColors[category.id] !== undefined && editedColors[category.id] !== category.color;
          ...
          <CardContent>
            <div className="grid gap-4 sm:grid-cols-2">
              {legacyCategories.map((category) => {
                ...
                return (
                  <div key={category.id} className="flex items-center gap-3 p-3 rounded-lg border opacity-75">
                    <div
                      className="w-10 h-10 rounded-full shrink-0 border-2 border-background shadow-sm"
                      style={{ backgroundColor: currentColor }}
                    />
