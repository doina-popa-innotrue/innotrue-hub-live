            ...
            <ScrollArea className="h-[70vh] pr-4">
              <div className="prose prose-sm dark:prose-invert max-w-none space-y-6">
                ...
                <section>
                  ...
                  <p>
                    We are the data controller responsible for your personal data in accordance 
                    with the EU General Data Protection Regulation (GDPR) and the German Federal 
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li><strong>Profile Data:</strong> Bio, avatar, professional information you choose to share</li>
                    <li><strong>Usage Data:</strong> Platform interactions, progress, assessment responses</li>
                    <li><strong>Technical Data:</strong> IP address, browser type, device information</li>
                    <li><strong>Payment Data:</strong> Billing address, VAT number (payment processing via Stripe)</li>
                    <li><strong>Analytics Data:</strong> Anonymized page views, feature usage patterns, and session data for platform improvement (opt-out available)</li>
                  </ul>
                </section>
                ...
                <section className="bg-blue-50 dark:bg-blue-950/30 p-4 rounded-lg border border-blue-200 dark:border-blue-800">
                  ...
                  <p className="text-blue-900 dark:text-blue-100 mt-2">
                    We collect anonymized usage analytics to improve our platform and user experience. 
                    This includes:
                  </p>
                  ...
                  <p className="mt-3 text-blue-800 dark:text-blue-200">
                    ...
                    via <Link to="/account" className="underline hover:text-blue-600 dark:hover:text-blue-300">Account Settings → Analytics Preferences</Link>. 
                    Opting out does not affect platform functionality.
                  </p>
                  <p className="mt-2 text-sm text-blue-700 dark:text-blue-300">
                    Analytics data is never sold or shared with third parties and is used solely 
                    for internal platform improvement purposes.
                  </p>
                </section>
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li><strong>Legitimate Interest (Art. 6(1)(f) GDPR):</strong> Platform security, fraud prevention</li>
                    <li><strong>Consent (Art. 6(1)(a) GDPR):</strong> Analytics, marketing communications</li>
                    <li><strong>Legal Obligation (Art. 6(1)(c) GDPR):</strong> Tax records, legal compliance</li>
                  </ul>
                </section>
                ...
                <section className="bg-amber-50 dark:bg-amber-950/30 p-4 rounded-lg border border-amber-200 dark:border-amber-800">
                  ...
                  <p className="text-amber-800 dark:text-amber-200">
                    Our platform infrastructure is hosted by Supabase, Inc. (USA) and Cloudflare, Inc. (USA).
                    This means your personal data may be transferred to and processed in the United States.
                  </p>
                  ...
                  <ul className="list-disc pl-6 space-y-1 text-amber-800 dark:text-amber-200">
                    ...
                    <li>Additional technical measures including encryption at rest and in transit</li>
                  </ul>
                  <p className="mt-3 text-amber-800 dark:text-amber-200">
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    ...
                    <li><strong>Terms Acceptance Records:</strong> 7 years (legal requirement)</li>
                    <li><strong>Payment Records:</strong> 10 years (German tax law - AO §147)</li>
                    <li><strong>Cookie Consent:</strong> 7 years (accountability requirement)</li>
                  </ul>
                </section>
                ...
                <section>
                  ...
                  <ul className="list-disc pl-6 space-y-1">
                    <li>Data Export: <Link to="/account" className="text-primary hover:underline">Account Settings → Data Export</Link></li>
                    <li>Account Deletion: <Link to="/account" className="text-primary hover:underline">Account Settings → Delete Account</Link></li>
                ...
                <section>
                  ...
                  <p>
                    ...
                    in particular in the EU Member State of your habitual residence, 
                    place of work, or place of the alleged infringement.
                  </p>
                  <p className="mt-2">
                    <strong>German Federal Commissioner for Data Protection:</strong><br />
