  ...
  useEffect(() => {
    const verifyToken = async () => {
      ...
      try {
        ...
        if (data.success) {
          setStatus('success');
          setMessage('Your email has been successfully updated. Please log in again with your new email address.');
        ...
        setStatus('error');
        setMessage(error.message || 'Failed to verify email change. The link may be invalid or expired.');
      }
    };
