...
import { BookOpen, Target, Brain, Users, Award, Calendar, FileText, MessageSquare, CircleDot, BarChart3, CheckSquare, Sparkles, UsersRound, Shield, Settings, Route, Coins, TrendingUp, Lightbulb, LayoutDashboard } from "lucide-react";
...
export default function FAQ() {
  ...
  const totalQuestions = dynamicFaqItems.reduce((acc, section) => acc + section.questions.length, 0);
  const filteredQuestions = filteredFaqItems.reduce((acc, section) => acc + section.questions.length, 0);
