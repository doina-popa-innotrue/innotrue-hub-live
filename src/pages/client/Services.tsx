      ...
      <div className="container max-w-4xl py-6 space-y-6">
        ...
        <Card className="bg-muted/50">
          ...
          <CardContent className="space-y-4 text-sm text-muted-foreground">
            <p>
              Credit services are activities that consume credits from your balance. Each service
              has a credit cost displayed next to it.
            </p>
            <ul className="list-disc list-inside space-y-1">
              <li>
                <strong>Track Discounts:</strong> Some services may have discounted rates based on
                your enrolled tracks.
              </li>
              <li>
                <strong>Feature Access:</strong> Certain services may require specific feature
                access through your plan or program.
              </li>
              <li>
                <strong>Credits Never Expire:</strong> Purchased credits don't expire, so you can
                use them whenever you're ready.
              </li>
            </ul>
            <div className="pt-2">
              <Button variant="link" className="p-0 h-auto" onClick={() => navigate("/credits")}>
