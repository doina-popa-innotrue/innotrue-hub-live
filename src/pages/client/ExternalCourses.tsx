        ...
        {courses.length === 0 ? (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Start tracking your learning from other platforms by adding your first external
                course
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
          <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
            <DialogHeader>
              ...
              <DialogDescription>
                {editingCourse ? "Update" : "Add"} details about a course you're taking on another
                platform
              </DialogDescription>
            </DialogHeader>
            {user && (
        ...
        <AlertDialog open={!!deletingCourse} onOpenChange={() => setDeletingCourse(null)}>
          <AlertDialogContent>
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                This will permanently delete "{deletingCourse?.title}" from your external courses.
