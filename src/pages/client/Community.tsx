  ...
  return (
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground">Connect with other members in the InnoTrue Community</p>
      </div>
      ...
      {circleConnection ? (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              You're connected to the InnoTrue Community
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            ...
            <Button
              onClick={handleAccessCircle}
              disabled={accessingCircle}
              className="w-full"
            >
            ...
            <Alert>
              ...
              <AlertDescription>
                Clicking the button above will generate a secure login link and open the InnoTrue Community in a new tab.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              ...
              Connection Request {pendingRequest.status === 'pending' ? 'Pending' : pendingRequest.status === 'approved' ? 'Approved' : 'Status'}
            </CardTitle>
            <CardDescription>
              {pendingRequest.status === 'pending' 
          ...
          <CardContent>
            <Alert>
              ...
              <AlertDescription>
                ...
                An administrator will review your request and set up your connection.
              </AlertDescription>
            </Alert>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <Alert>
              <AlertCircle className="h-4 w-4" />
              <AlertDescription>
                Your InnoTrue Community account hasn't been set up yet. Request a connection to get access to the community.
              </AlertDescription>
            </Alert>
