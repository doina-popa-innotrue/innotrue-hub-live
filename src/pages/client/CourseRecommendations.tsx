...
export default function CourseRecommendations() {
  ...
  const { canConsume, consume, remaining, isConsuming } = useConsumableFeature('ai_recommendations');
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Our AI analyzes your completed programs, acquired skills, and interests to suggest relevant next steps in your learning journey.
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              {!recommendations && (
                <div className="text-center py-12">
                  ...
                  <Button onClick={generateRecommendations} disabled={loading || isConsuming || !canConsume}>
                    {loading ? (
                      <>
              ...
              {recommendations && (
                <div className="space-y-4">
                  ...
                  <Button onClick={generateRecommendations} disabled={loading || isConsuming || !canConsume} variant="outline">
                    {loading ? (
                      <>
                        <Loader2 className="h-4 w-4 mr-2 animate-spin" />
                        Regenerating...
