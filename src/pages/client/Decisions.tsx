...
export default function Decisions() {
  ...
  const createFromTemplate = useMutation({
    mutationFn: async (template: DecisionTemplate) => {
      ...
      const { error: optionsError } = await supabase.from("decision_options").insert(optionsData);
      ...
      const { error: valuesError } = await supabase.from("decision_values").insert(valuesData);
