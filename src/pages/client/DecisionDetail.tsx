    ...
    <div className="p-6 space-y-6">
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    This will permanently delete the decision and all associated data including journal entries, options, and comments. This action cannot be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
      ...
      <Tabs defaultValue="overview" className="space-y-4">
        <TabsList className="grid w-full grid-cols-4 md:grid-cols-8">
          ...
          {hasCapability('values_alignment') && <TabsTrigger value="values">Values</TabsTrigger>}
          {hasCapability('advanced_frameworks') && <TabsTrigger value="models">Models</TabsTrigger>}
          {hasCapability('reminders_followups') && <TabsTrigger value="reminders">Follow-Ups</TabsTrigger>}
          {hasCapability('decision_journaling') && <TabsTrigger value="journal">Journal</TabsTrigger>}
        ...
        <TabsContent value="options">
          <Card>
            <CardContent className="pt-6">
              {!isNew && id ? <OptionsAnalysis decisionId={id} /> : <p className="text-sm text-muted-foreground">Save your decision first to add options</p>}
            </CardContent>
          </Card>
        </TabsContent>
        ...
        <TabsContent value="values">
          <CapabilityGate capability="values_alignment">
            <Card>
              <CardContent className="pt-6">
                {!isNew && id ? <ValuesAlignment decisionId={id} /> : <p className="text-sm text-muted-foreground">Save your decision first to add values</p>}
              </CardContent>
            </Card>
          </CapabilityGate>
        </TabsContent>
        ...
        <TabsContent value="reflection">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {status === "made" ? "Reflect on how the decision went" : "Available after decision is made"}
              </CardDescription>
            </CardHeader>
            <CardContent className="pt-6">
