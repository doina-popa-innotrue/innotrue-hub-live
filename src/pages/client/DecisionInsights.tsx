...
export default function DecisionInsights() {
  ...
  const { canConsume, consume, remaining, isConsuming, isLoading: consumableLoading } = useConsumableFeature('ai_insights');
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <Button
                ...
                disabled={isLoading || isConsuming || !canConsume}
              >
                <RefreshCw className={`h-4 w-4 mr-2 ${isLoading || isConsuming ? "animate-spin" : ""}`} />
