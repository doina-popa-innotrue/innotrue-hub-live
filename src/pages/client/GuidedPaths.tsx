    ...
    <div className="space-y-6">
      <div className="text-center py-12">
        ...
        <p className="text-muted-foreground max-w-md mx-auto mb-6">
          Follow curated paths with goals, milestones, and tasks to help you achieve your objectives
          systematically.
        </p>
    ...
    queryFn: async () => {
      ...
      const familiesWithData = await Promise.all(
        (familiesData || []).map(async (family) => {
          ...
          const conditionsByTemplate = (conditionsData || []).reduce(
            (acc, c) => {
                ...
                <CardContent className="py-12 text-center">
                  ...
                  <p className="text-muted-foreground">
                    {search
                      ...
                      : "No guided path journeys are available yet"}
                  </p>
                </CardContent>
              </Card>
            ) : (
              ...
              <Card>
                <CardContent className="py-12 text-center">
                  ...
                  <p className="text-muted-foreground">
                    {search
                      ? "Try adjusting your search terms"
                      : "No standalone templates are available yet"}
                  </p>
                </CardContent>
              </Card>
            ) : (
