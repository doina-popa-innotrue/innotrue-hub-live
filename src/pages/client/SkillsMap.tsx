...
export default function SkillsMap() {
  ...
  async function fetchSkillsData() {
    ...
    const { data: moduleSkills } = await supabase.from("module_skills").select(`
        skill_id,
        module:program_modules(id, title, program:programs(id, name))
      `);

    // Build available skills map
    const skillModulesMap: Record<
      string,
      { id: string; title: string; program_id: string; program_name: string }[]
    > = {};
  ...
  const skillsByCategory = acquiredSkills.reduce(
    (acc, us) => {
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          <div className="min-w-0 flex-1">
            ...
            <p className="text-muted-foreground mt-1">
              Track your acquired skills and share them on your public profile
            </p>
          </div>
          {publicProfileSlug && (
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex justify-between text-sm">
                <span>
                  {acquiredSkills.length} of {totalPossibleSkills} skills acquired
                </span>
                        ...
                        >
                          ...
                          <div className="flex items-center gap-2">
                            <Button
                              ...
                              size="sm"
                              onClick={() =>
                                toggleSkillVisibility(userSkill.id, userSkill.is_public)
                              }
                              title={
                                userSkill.is_public
              ...
              <Card>
                <CardContent className="py-12 text-center">
                  ...
                  <h3 className="text-lg font-medium mb-2">
                    You've acquired all available skills!
                  </h3>
                  <p className="text-muted-foreground">Congratulations on your learning journey.</p>
                </CardContent>
              </Card>
            ) : (
              <>
                ...
                <div className="flex flex-col sm:flex-row gap-3 sm:items-center sm:justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <ToggleGroup
                      type="single"
                      value={viewMode}
                      onValueChange={(v) => v && setViewMode(v as "grid" | "grouped")}
                    >
