...
export default function OrgAdminFAQ() {
  ...
  const faqSections: FAQSection[] = [
    {
      ...
      items: [
        {
          question: "What is an Organization Admin?",
          value: "what-is-org-admin",
          answer: (
        ...
        {
          question: "How is Organization Admin different from Platform Admin?",
          value: "org-vs-platform-admin",
          answer: (
            <div className="space-y-3">
              <p className="text-sm text-muted-foreground">
                Organization Admins manage their own organization, while Platform Admins manage the
                entire platform.
              </p>
              <Table>
                <TableHeader>
        ...
        {
          question: "How do I navigate between my organization and personal views?",
          value: "navigation",
          answer: (
            <p className="text-sm text-muted-foreground">
              Use the role switcher in the sidebar to toggle between your Organization Admin view
              and your personal client view (if you have one). Organization-specific pages are under
              the "Org Admin" section in the sidebar.
            </p>
          ),
        },
      ],
      ...
      items: [
        {
          ...
          answer: (
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">
                Go to <strong>Members → Invite Member</strong>. Enter the email address of the
                person you want to invite. They will receive an email with instructions to join your
                organization.
              </p>
              <div className="rounded-lg border p-4 bg-muted/30">
                ...
                <p className="text-sm text-muted-foreground">
                  Invitations expire after 7 days. You can resend invitations from the pending
                  invites list.
                </p>
              </div>
            </div>
        ...
        {
          question: "What happens when I reach my seat limit?",
          value: "seat-limits",
          answer: (
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">
        ...
        {
          question: "How do I remove a member from my organization?",
          value: "remove-member",
          answer: (
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">
        ...
        {
          question: "What member roles are available?",
          value: "member-roles",
          answer: (
            <div>
              <Table>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell>
                      Access enrolled programs, complete modules, track progress
                    </TableCell>
                  </TableRow>
                  <TableRow>
                    <TableCell className="font-medium">Org Admin</TableCell>
                    <TableCell>
                      Full organization management including members, billing, and settings
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
              <p className="text-xs text-muted-foreground mt-3">
                Organization admins can promote members to admin status or demote admins to regular
                members.
              </p>
            </div>
          ),
        ...
        {
          question: "Can I invite multiple members at once?",
          value: "bulk-invite",
          answer: (
            <p className="text-sm text-muted-foreground">
              Yes! Use the bulk invite feature in <strong>Members → Bulk Invite</strong>. You can
              paste a list of email addresses (one per line or comma-separated) to send invitations
    ...
    },
    {
      ...
      items: [
        {
          question: "How do I see which programs my organization has access to?",
          value: "view-programs",
          answer: (
            <div>
              <p className="text-sm text-muted-foreground">
        ...
        {
          question: "How do I enroll a member in a program?",
          value: "enroll-member",
          answer: (
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">
                Go to <strong>Enrollments → Add Enrollment</strong>. Select the member and the
                program you want to enroll them in.
              </p>
              <div className="rounded-lg border p-4 bg-muted/30">
        ...
        },
        {
          ...
          answer: (
            <div>
              <p className="text-sm text-muted-foreground">
                The <strong>Enrollments</strong> page shows progress for all enrolled members. You
                can see:
              </p>
              <ul className="text-sm list-disc list-inside text-muted-foreground mt-2">
        ...
        {
          question: "What are cohorts and how do they work?",
          value: "cohort-enrollment",
          answer: (
            <div>
              <p className="text-sm text-muted-foreground">
                Some programs are organized into cohorts—groups of participants who go through the
                program together. When enrolling in a cohort-based program, you'll select which
                cohort to join.
              </p>
              <p className="text-sm text-muted-foreground mt-2">Cohorts typically have:</p>
              <ul className="text-sm list-disc list-inside text-muted-foreground">
        ...
        {
          question: "Can I unenroll a member from a program?",
          value: "unenroll-member",
          answer: (
            <p className="text-sm text-muted-foreground">
      ...
      items: [
        {
          ...
          answer: (
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">
                Credits are the currency used for certain platform services. Your organization has a
                credit balance that can be used for:
              </p>
              <ul className="text-sm list-disc list-inside text-muted-foreground">
        ...
        },
        {
          ...
          answer: (
            <p className="text-sm text-muted-foreground">
              ...
              credit package and complete the payment. Credits are added to your balance
              immediately.
            </p>
          ),
        },
        {
          question: "How do I view invoices and payment history?",
          value: "invoices",
          answer: (
            <p className="text-sm text-muted-foreground">
        ...
        },
        {
          ...
          answer: (
            <p className="text-sm text-muted-foreground">
              ...
              balance falls below a threshold. Configure this in{" "}
              <strong>Billing & Credits → Payment Methods</strong>.
            </p>
          ),
        },
        {
          question: "How are credits allocated to members?",
          value: "credit-allocation",
          answer: (
            <p className="text-sm text-muted-foreground">
              Organization credits are pooled. When members use credit-consuming services, credits
              are drawn from the organization balance. You can view usage by member in the Analytics
              section.
            </p>
          ),
        },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: (
            <p className="text-sm text-muted-foreground">
              Yes, most analytics views include an export button. You can download reports as CSV
              files for further analysis or reporting to stakeholders.
            </p>
          ),
        },
        {
          ...
          answer: (
            <p className="text-sm text-muted-foreground">
              Analytics data is updated in near real-time. Progress and engagement metrics are
              refreshed whenever members complete activities.
            </p>
          ),
        },
        {
          question: "Can I see individual member progress?",
          value: "member-analytics",
          answer: (
            <p className="text-sm text-muted-foreground">
              Yes, click on any member in the Members list to see their detailed progress including
              program completions, recent activity, and time spent on the platform.
            </p>
          ),
        },
      ],
    },
    {
      ...
      items: [
        {
          question: "Can I create organization-specific terms?",
          value: "org-terms",
          answer: (
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">
        ...
        {
          question: "How do I track who has accepted terms?",
          value: "terms-tracking",
          answer: (
            <p className="text-sm text-muted-foreground">
              The Terms & Conditions page shows acceptance status for all members. You can see when
              each member accepted the current version of your terms.
            </p>
          ),
        },
        {
          question: "What happens when I update terms?",
          value: "terms-update",
          answer: (
            <p className="text-sm text-muted-foreground">
              When you publish updated terms, members will be prompted to review and accept the new
              version on their next login. You can make acceptance mandatory before they can access
              programs.
            </p>
          ),
        },
      ...
      items: [
        {
          ...
          answer: (
            <p className="text-sm text-muted-foreground">
              ...
              name, logo, description, and contact information. These details appear to your
              members.
            </p>
          ),
        },
        ...
        {
          question: "Can I have multiple Organization Admins?",
          value: "multiple-admins",
          answer: (
            <p className="text-sm text-muted-foreground">
              Yes, you can promote any member to Organization Admin status from the Members page.
              Having multiple admins ensures continuity and shared responsibility for managing your
              organization.
            </p>
          ),
        },
        {
          question: "How do I transfer ownership of the organization?",
          value: "transfer-ownership",
          answer: (
            <p className="text-sm text-muted-foreground">
              Contact InnoTrue Hub support to transfer primary organization ownership. You can
              assign additional admins yourself, but primary ownership transfer requires support
              assistance.
            </p>
          ),
        },
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer: (
            <p className="text-sm text-muted-foreground">
              Contact your account manager to set up scheduled reports delivered via email. Weekly
              or monthly summaries can be configured based on your needs.
            </p>
          ),
        },
      ],
      ...
      items: [
        {
          ...
          answer: (
            <div>
              <p className="text-sm text-muted-foreground">For assistance, you can:</p>
              <ul className="text-sm list-disc list-inside text-muted-foreground mt-2">
                <li>
                  Email: <strong>support@innotrue.com</strong>
                </li>
        ...
        },
        {
          ...
          answer: (
            <p className="text-sm text-muted-foreground">
              ...
              Your account manager's contact information is available in{" "}
              <strong>Settings → Support</strong>.
            </p>
          ),
        },
        {
          question: "Where do my members go for help?",
          value: "member-help",
          answer: (
            <p className="text-sm text-muted-foreground">
              Members can access the client FAQ from their dashboard. For organization-specific
              questions, they can contact you as their Organization Admin or reach out to InnoTrue
              Hub support.
            </p>
          ),
        },
        {
          question: "Is there training available for Organization Admins?",
          value: "training",
          answer: (
            <p className="text-sm text-muted-foreground">
  ...
  const filteredSections = useMemo(() => {
    ...
    return faqSections
      .map((section) => ({
        ...section,
        items: section.items.filter((item) => item.question.toLowerCase().includes(query)),
      }))
