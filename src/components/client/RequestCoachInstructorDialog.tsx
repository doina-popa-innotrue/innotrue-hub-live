  ...
  const { data: currentAssignments } = useQuery({
    ...
    queryFn: async () => {
      ...
      const [coachResult, instructorResult] = await Promise.all([
        supabase.from("client_coaches").select("coach_id").eq("client_id", user.id),
        supabase.from("client_instructors").select("instructor_id").eq("client_id", user.id),
      ]);
      ...
      // Map IDs to names
      const programTeam = programTeamData
        .map((pt) => ({
          ...
          <div className="space-y-4">
            ...
            {((currentAssignments?.directCoaches?.length || 0) > 0 ||
              ...
              <div className="p-3 bg-primary/5 border border-primary/20 rounded-lg space-y-3">
                ...
                {currentAssignments?.directCoaches &&
                  currentAssignments.directCoaches.length > 0 && (
                ...
                {currentAssignments?.directInstructors &&
                  currentAssignments.directInstructors.length > 0 && (
                    <div className="space-y-1">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Submit a request for a coach, instructor, or both. An administrator will review your
                request and assign someone to help you.
              </DialogDescription>
            </DialogHeader>
