    ...
    <div className="grid gap-6 lg:grid-cols-2">
          ...
          {dropOffData.length > 0 ? (
            <div className="space-y-4">
              {dropOffData.map((item, index) => {
                const percentage =
                  totalDropOffs > 0 ? ((item.exit_count / totalDropOffs) * 100).toFixed(1) : "0";
            ...
            <div className="flex flex-col items-center justify-center py-12 text-muted-foreground">
              ...
              <p className="text-sm mt-1">
                This requires sufficient page_view events with path data
              </p>
            </div>
          )}
        </CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Errors that users are experiencing</CardDescription>
        </CardHeader>
        <CardContent>
          {errorData.length > 0 ? (
            <div className="space-y-4">
