...
interface OrganizationTermsManagerProps {
  organizationId: string;
}

export function OrganizationTermsManager({ organizationId }: OrganizationTermsManagerProps) {
  const [terms, setTerms] = useState<OrganizationTerms[]>([]);
  const [loading, setLoading] = useState(true);
  const [openDialog, setOpenDialog] = useState(false);
  const [editingTerm, setEditingTerm] = useState<OrganizationTerms | null>(null);
  ...
  function openEditDialog(term: OrganizationTerms) {
    setEditingTerm(term);
    setTitle(term.title);
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <div>
              <CardTitle>Organization Terms & Conditions</CardTitle>
              <CardDescription>Manage T&Cs that members must accept to participate</CardDescription>
            </div>
          </div>
      ...
      <CardContent>
        {terms.length === 0 ? (
          <div className="text-center py-8 text-muted-foreground">
            ...
            <p>No organization terms defined</p>
            <p className="text-sm mt-1">Create your first version to require member acceptance</p>
          </div>
        ) : (
          <Table>
            <TableHeader>
            ...
            <div className="space-y-4 pr-1">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder="e.g., Organization Terms and Conditions"
                />
              </div>
              ...
              <div className="space-y-4 border rounded-lg p-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Require new members to accept before accessing organization content
                    </p>
                  </div>
                  <Switch
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Make this the active version shown to members
                    </p>
                  </div>
