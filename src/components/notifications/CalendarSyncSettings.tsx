      ...
      <CardContent className="space-y-6">
                ...
                <AlertDialog>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        This will invalidate your current calendar subscription URL. You'll need to update the URL in any calendar apps that are currently subscribed.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
        ...
        {!isEnabled && (
          <Alert>
            ...
            <AlertDescription>
              Enable calendar sync to see your scheduled sessions, group meetings, and assignment due dates in your calendar app.
            </AlertDescription>
          </Alert>
        )}
      </CardContent>
