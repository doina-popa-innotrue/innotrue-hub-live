      ...
      <CardContent className="space-y-4">
        ...
        <div className="flex items-start gap-2 p-3 bg-muted/50 rounded-lg">
          ...
          <p className="text-xs text-muted-foreground">
            We collect anonymized usage data (page views, feature usage) to understand how the platform 
            is used and identify areas for improvement. This data is never sold or shared with third parties. 
            Your choice here does not affect essential platform functionality.
          </p>
        </div>
      </CardContent>
    </Card>
