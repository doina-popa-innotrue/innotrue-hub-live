  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>View the client's reflections for this module</CardDescription>
      </CardHeader>
      <CardContent>
        {reflections.length === 0 ? (
          <p className="text-muted-foreground py-4 text-center">No reflections from client yet.</p>
        ) : (
