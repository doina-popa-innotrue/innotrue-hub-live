...
import { Loader2, Paperclip, Link, Image, FileText, Download, Trash2, ExternalLink } from 'lucide-react';
...
export default function FeedbackAttachments({ feedbackId, canEdit = false }: FeedbackAttachmentsProps) {
