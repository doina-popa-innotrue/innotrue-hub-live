...
const DEFAULT_DESCRIPTION = 'InnoTrue Hub - Your learning and development platform for personal and professional growth.';
...
export function SEOHead({
  ...
  }, [fullTitle, truncatedDescription, canonicalUrl, ogImage, ogType, twitterCard, noIndex, noFollow, publishedTime, modifiedTime, author, jsonLd]);
