...
interface PlanLockOverlayProps {
  reason: 'plan_required' | 'payment_outstanding' | 'separate_purchase_required' | 'enrollment_paused';
      ...
      <Card className={`border-amber-500/30 bg-gradient-to-br from-amber-500/5 to-orange-500/5 ${className}`}>
        <CardContent className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-muted-foreground mb-6 max-w-md">
            This is a premium program that requires a separate purchase. Contact us to learn more about pricing and enrollment options.
          </p>
      ...
      <CardContent className="flex flex-col items-center justify-center py-12 text-center">
        {reason === 'enrollment_paused' ? (
          <>
            ...
            <p className="text-muted-foreground mb-6 max-w-md">
              Your access to this program has been temporarily paused by an administrator. 
