...
export function OrganizationSharingConsentSection({
  ...
  const { consent, isLoading, toggleConsent, giveFullConsent, revokeAllConsent, updateConsent } =
    useOrganizationSharingConsent(organizationId);
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Control what data {organizationName} admins can access. Your organization may have their
          own requirements - check with them if unsure.
        </CardDescription>
      </CardHeader>
