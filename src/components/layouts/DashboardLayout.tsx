...
export function DashboardLayout({
  ...
  const handleRestartTour = () => {
    const tourId = userRole === 'admin' ? 'admin-tour' : userRole === 'instructor' || userRole === 'coach' ? 'instructor-tour' : 'client-tour';
    resetTour(tourId);
    toast({
  ...
  return <PlatformTermsAcceptanceGate>
      <SidebarProvider>
        <SkipLink targetId="main-content">Skip to main content</SkipLink>
        <SkipLink targetId="sidebar-nav" className="focus:top-12">Skip to navigation</SkipLink>
        <div className="flex h-screen w-full flex-col overflow-hidden">
          ...
          >
            ...
            <span className="text-lg font-bold mt-1 hidden lg:block">The platform for lifelong development</span>
