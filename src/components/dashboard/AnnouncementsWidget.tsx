...
const colorClasses: Record<string, { bg: string; border: string; icon: string }> = {
  ...
  orange: { bg: 'bg-orange-50 dark:bg-orange-950/30', border: 'border-orange-200 dark:border-orange-800', icon: 'text-orange-600 dark:text-orange-400' },
                ...
                {rollingAnnouncements.map((_, idx) => (
                  <button
                    ...
                    className={cn(
                      ...
                      idx === rollingIndex ? 'w-4 bg-primary' : 'w-1.5 bg-muted-foreground/30 hover:bg-muted-foreground/50'
                    )}
