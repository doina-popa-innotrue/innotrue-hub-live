  ...
  return (
    <Card className="border-success/30 bg-success/5">
      <CardHeader className="pb-3">
        ...
        <CardDescription>
          Your assignments that have been reviewed
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-3">
        {gradedAssignments.map((assignment) => (
          <div 
            ...
            onClick={() => navigate(`/programs/${assignment.program_id}/modules/${assignment.module_id}`)}
          >
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-1">
                  Reviewed by {assignment.scorer_name} • {formatDistanceToNow(new Date(assignment.scored_at), { addSuffix: true })}
                </p>
              </div>
            </div>
