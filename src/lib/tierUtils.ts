...
export function hasTierAccess(
  ...
  const userTierIndex = programTiers.findIndex(
    t => t.toLowerCase() === normalizedUserTier
  );
  const moduleTierIndex = programTiers.findIndex(
    t => t.toLowerCase() === normalizedModuleTier
  );
