    ...
    sections: [
      {
        ...
        children: [
          ...
          createParagraph('Program Management: Create and deliver structured learning programs with modules, sessions, and assessments', { bullet: true }),
          createParagraph('Guided Paths: Personalized learning journeys through conditional survey-based recommendations', { bullet: true }),
          createParagraph('Coaching Support: Connect clients with coaches for personalized guidance', { bullet: true }),
          createParagraph('Goal Tracking: Set, track, and achieve personal and professional goals', { bullet: true }),
          createParagraph('Decision Support: Structured frameworks for making important decisions with AI insights', { bullet: true }),
          createParagraph('Assessments: Wheel of Life, capability assessments, scenario-based assessments, and psychometric tools', { bullet: true }),
          createParagraph('Group Learning: Collaborative learning through managed groups with sessions and check-ins', { bullet: true }),
          createParagraph('Skills Tracking: Monitor skill development across programs', { bullet: true }),
          createParagraph('Credit System: Unified credits for consuming premium services', { bullet: true }),
          createParagraph('Organization Management: B2B support with sponsored plans and org-specific features', { bullet: true }),
          createParagraph('Session Scheduling: Cal.com and Google Calendar integration for seamless scheduling', { bullet: true }),
          createParagraph('Email Notifications: Automated emails for sessions, assignments, reminders, and more', { bullet: true }),
          createParagraph('External Integrations: TalentLMS, Circle, Google Drive, Lucid, ActiveCampaign, and more', { bullet: true }),
          createParagraph('Announcements: Admin-managed news and updates displayed to clients', { bullet: true }),
          createParagraph('Public Profiles: Shareable professional profiles for clients', { bullet: true }),
          new Paragraph({ children: [new PageBreak()] }),
          ...
          createTable(
            ...
            [
              ['Admin', 'Platform administrators with full access', 'Manage all users, programs, settings, configurations, and exports'],
              ['Org Admin', 'Organization administrators for B2B clients', 'Manage organization members, enrollments, billing, and org-specific terms'],
              ['Instructor', 'Program instructors who deliver content', 'Manage assigned programs, provide feedback, view student progress'],
              ['Coach', 'Personal coaches for 1:1 support', 'View assigned clients, provide feedback, track goals and decisions'],
              ['Client', 'End users enrolled in programs', 'Access enrolled programs, track goals, use assessment tools'],
            ]
          ),
          createParagraph(''),
          createParagraph('Note: Users can have multiple roles simultaneously. Role switching is available in the sidebar for multi-role users.'),
          createHeading('Multi-Role Architecture', HeadingLevel.HEADING_2),
          createParagraph('A single user can hold multiple roles (e.g., admin + client, instructor + coach).'),
          createParagraph('Users have access to all capabilities of all their assigned roles combined.'),
          createParagraph('Staff members (coaches/instructors) who are also clients get both staff capabilities and a plan assignment.'),
          new Paragraph({ children: [new PageBreak()] }),
          ...
          createParagraph('Add modules with various types (content, sessions, assignments, academy)'),
          ...
          createParagraph('Subscription Plans: Configure tier levels, features, and credit allowances'),
          createParagraph('Features Management: Define features, mark as system-protected, assign to plans/tracks/add-ons'),
          createParagraph('Export Configuration: Download feature assignments and credit configuration as JSON'),
          ...
          createParagraph('Platform Terms: Manage terms of service with versioning and acceptance tracking'),
          createParagraph('Announcements: Create news items with categories for client dashboard'),
          createParagraph('System Settings: Configure support email, recurrence limits, and other platform settings'),
          
          createHeading('Content Management', HeadingLevel.HEADING_2),
          createParagraph('Resource Library: Manage shared resources with canonical IDs for external mapping'),
          createParagraph('Skills Management: Define and track skills across the platform'),
          createParagraph('Assessment Management: Configure capability and psychometric assessments'),
          ...
          createParagraph('Define credit-based services with categories (AI, Goals, Programs, Sessions, etc.)'),
          ...
          createParagraph('Wheel of Life: Self-assessment across life domains with historical tracking'),
          ...
          createParagraph('Programs are the primary container for learning content. Each program can contain multiple modules organized in a specific order.'),
          
          createHeading('Module Types', HeadingLevel.HEADING_2),
          createTable(
            ['Type', 'Description', 'Client Actions'],
            [
              ['Content', 'Text-based learning material with rich content', 'Read content, view resources, mark complete'],
              ['Session', 'Live or scheduled sessions with instructors/coaches', 'Request sessions, join meetings, view recordings'],
              ['Assignment', 'Work submissions requiring instructor review', 'Submit work, receive feedback and scores'],
              ['Academy', 'Linked TalentLMS courses', 'Access external course, track progress'],
              ['Self-Paced', 'Modules completed at client discretion', 'Work through content independently'],
            ]
          ),
          ...
          createParagraph('Modules can have prerequisites that must be completed before access is granted.'),
          createParagraph('Prerequisites are configured in the module edit dialog under the Prerequisites tab.'),
          ...
          createParagraph('Cal.com Integration: Primary scheduling system for individual and group sessions', { bullet: true }),
          createParagraph('Google Calendar: Create calendar events directly for sessions', { bullet: true }),
          createParagraph('Manual Scheduling: Staff can manually create sessions with custom dates', { bullet: true }),
          ...
          createParagraph('Cal.com event types can be mapped to specific programs, modules, or session targets.'),
          createParagraph('Mappings support: Individual sessions, group sessions, or default program module sessions.'),
          ...
          createParagraph('Emails include: Date/time, staff name, meeting link, and program context'),
          ...
          createParagraph('Individual sessions in a recurring series can be modified independently'),
          new Paragraph({ children: [new PageBreak()] }),

          // Section 9: Guided Paths
          createHeading('9. Guided Paths', HeadingLevel.HEADING_1),
          createParagraph('Guided Paths help clients discover personalized learning journeys through structured surveys.'),
          
          createHeading('Path Families', HeadingLevel.HEADING_2),
          createParagraph('Paths are organized into families (e.g., "Career Development", "Leadership").'),
          ...
          createParagraph('A self-assessment tool for evaluating satisfaction across configurable life domains:'),
          createParagraph('Default domains include: Career/Work, Finance/Wealth, Health/Wellness, Family/Friends, Romance/Partnership, Personal Growth, Fun/Recreation, Physical Environment, Community/Social, Purpose/Spirituality', { italic: true }),
          ...
          createParagraph('Structured assessments for evaluating specific capabilities or competencies.'),
          createParagraph('Features include:'),
          createParagraph('Multiple domains with custom questions', { bullet: true }),
          createParagraph('Self-assessment and instructor/coach evaluation options', { bullet: true }),
          ...
          createParagraph('Staff can view shared assessments in their dedicated Assessments dashboard'),
          ...
          createParagraph('Scenario-based assessments enable evaluation of client competencies through realistic, multi-page hypothetical situations.'),
          
          createHeading('Template Structure', HeadingLevel.HEADING_2),
          createParagraph('Templates are organized into sections (pages) containing paragraphs of content.'),
          ...
          createParagraph('Staff manually assign scenarios to individual clients or bulk-assign to module enrollments.'),
          createParagraph('Assignments track enrollment and module context for independent progress.'),
          ...
          createParagraph('Assigned due dates and priorities (Eisenhower matrix)', { bullet: true }),
          ...
          createParagraph('A structured approach to making important decisions with multiple frameworks and tools.'),
          ...
          createParagraph('Buyers Model, 10-10-10 Rule, Internal Check, Stop Rule, Yes/No Rule, Crossroads Model'),
          ...
          createParagraph('Career, Financial, Relationship, Business, Education, Health, Home, Relocation', { bullet: true }),
          new Paragraph({ children: [new PageBreak()] }),
          ...
          createParagraph('Automatic rollover handling via credit-maintenance edge function', { bullet: true }),
          ...
          createParagraph('Scheduled group sessions with video conferencing links', { bullet: true }),
          ...
          createParagraph('Locked: Feature is monetized but user lacks access (shown with lock icon)'),
          ...
          createParagraph('Admins can export feature assignments as JSON for backup or documentation.'),
          ...
          createParagraph('The platform uses a tiered access system where higher tiers inherit access from lower tiers.'),
          createTable(
          ...
          createTable(
            ...
            [
              ['Session Scheduled', 'Session created with confirmed date/time', 'Client enrolled in the session'],
          ...
          createParagraph('NOTE: This feature is currently database-managed. A dedicated admin UI for managing auth contexts is planned for future development.'),
          createParagraph(''),
          
          createHeading('Overview', HeadingLevel.HEADING_2),
          createParagraph('Authentication Contexts allow creating customized landing pages for different user acquisition channels, organizations, or programs. Each context can have unique branding, messaging, and automatic enrollment behavior.'),
          
          createHeading('URL Parameters', HeadingLevel.HEADING_2),
          createTable(
            ['Parameter', 'Purpose', 'Example'],
            [
              ['ref', 'Context slug to load specific branding/messaging', '/auth?ref=salesforce-cta'],
              ...
              ['track', 'Track parameter for track-specific landing', '/auth?track=executive-coaching'],
          ...
          createParagraph('Auto-enrollment settings (program_id, track_id, organization_id)', { bullet: true }),
          
          createHeading('Signup Context Tracking (signup_contexts table)', HeadingLevel.HEADING_2),
          createParagraph('When users sign up through a contextual link, their entry context is recorded for:'),
          createParagraph('Attribution and analytics', { bullet: true }),
          createParagraph('Post-signup automation (enrollment, track assignment)', { bullet: true }),
          createParagraph('UTM parameter tracking', { bullet: true }),
          createParagraph('This data is additive—existing users accessing new context links can gain additional enrollments without disrupting existing access.'),
          
          createHeading('Multi-Context Support', HeadingLevel.HEADING_2),
          createParagraph('Users can belong to multiple organizations, tracks, and programs simultaneously. Context-based signups add to existing access rather than replacing it.'),
