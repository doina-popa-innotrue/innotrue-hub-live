...
export const WHEEL_CATEGORY_DESCRIPTIONS: Record<WheelCategory, string> = {
  ...
  career_business: 'Your professional life, job satisfaction, career growth, and work achievements.',
...
export function getSnapshotRatings(snapshot: WheelSnapshot): { category: WheelCategory; label: string; value: number }[] {
