...
const INNOTRUE_LOGO_BASE64 =
  "data:image/png;base64,";
...
export const generateLearningTranscript = (
  ...
  if (programs.length === 0) {
    ...
    programs.forEach((program, index) => {
      ...
      yPosition += lineHeight;
      doc.text(
        `   Progress: ${Math.round(program.progress)}% (${program.completedModules}/${program.totalModules} modules)`,
        25,
        yPosition,
      );
      yPosition += lineHeight;
  ...
  if (externalCourses.length === 0) {
    ...
    externalCourses.forEach((course, index) => {
      ...
      if (course.planned_date) {
        doc.text(
          `   Start Date: ${new Date(course.planned_date).toLocaleDateString()}`,
          25,
          yPosition,
        );
        yPosition += lineHeight;
  ...
  for (let i = 1; i <= pageCount; i++) {
    ...
    doc.setFontSize(8);
    doc.setFont("helvetica", "italic");
    doc.text(`Page ${i} of ${pageCount} - Generated by InnoTrue Hub`, 105, pageHeight - 10, {
      align: "center",
    });
  }
