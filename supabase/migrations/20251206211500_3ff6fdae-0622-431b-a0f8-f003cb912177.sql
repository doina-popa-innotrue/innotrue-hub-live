-- Drop and recreate the public_profiles view to respect privacy settings
...
COMMENT ON VIEW public.public_profiles IS 'Only shows profiles where users have opted to make their profile public (is_public=true). Individual fields are shown/hidden based on user visibility preferences.';